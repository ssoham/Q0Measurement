...
from q0Utils import (AMPLITUDE_TOL, ARCHIVER_TIME_INTERVAL, CAL_HEATER_DELTA, CAV_HEATER_RUN_LOAD,
                     DELTA_NEEDED_FOR_FLATNESS, HEATER_TOL, INITIAL_CAL_HEAT_LOAD, JT_SEARCH_OVERLAP_DELTA,
                     JT_SEARCH_TIME_RANGE, MAX_DS_LL, MIN_DS_LL, MIN_RUN_DURATION, NUM_CAL_STEPS, NUM_LL_POINTS_TO_AVG,
                     TARGET_LL_DIFF, TEST_MODE, TimeParams, VALVE_POS_TOL, ValveParams, cagetPV, caputPV,
                     collapseGradVals, collapseHeaterVals, compatibleMkdirs, compatibleNext, genAxis,
                     getAndParseRawData, getDataAndHeaterCols, getTimeParams, isYes, writeAndFlushStdErr, writeAndWait)
...
class Container(object):
    ...
    def getRefValveParams(self, timeRange=JT_SEARCH_TIME_RANGE):
        ...
        while (loopStart - searchStart) <= timedelta(hours=timeRange):
            ...
            searchStart -= timedelta(hours=JT_SEARCH_OVERLAP_DELTA)
        ...
        return self.getRefValveParams(DELTA_NEEDED_FOR_FLATNESS + 0.5)
